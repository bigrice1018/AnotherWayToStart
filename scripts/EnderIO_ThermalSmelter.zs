...
mods.thermalexpansion.Smelter.addRecipe(12000, <minecraft:iron_ingot>, <minecraft:ender_pearl>, <EnderIO:itemAlloy:5>);

mods.thermalexpansion.Smelter.removeRecipe(<ore:dustObsidian> * 4, <ore:ingotSteel>);
mods.thermalexpansion.Smelter.removeRecipe(<ore:dustObsidian> * 4, <ore:dustSteel>);
mods.thermalexpansion.Smelter.addRecipe(12000, <minecraft:iron_ingot>, <minecraft:obsidian>, <contenttweaker:darkSteel_Base>);
mods.thermalexpansion.Smelter.addRecipe(12000, <contenttweaker:darkSteel_Base>, <ThermalFoundation:material:2>, <EnderIO:itemAlloy:6>);

mods.thermalexpansion.Smelter.removeRecipe(<minecraft:soul_sand>, <minecraft:gold_ingot>);
mods.thermalexpansion.Smelter.addRecipe(12000, <minecraft:soul_sand>, <minecraft:gold_ingot>, <EnderIO:itemAlloy:7>);

mods.thermalexpansion.Smelter.addRecipe(6000, <minecraft:gold_ingot>, <minecraft:glowstone_dust>, <contenttweaker:energeticAlloy_Base>);
mods.thermalexpansion.Smelter.addRecipe(6000, <contenttweaker:energeticAlloy_Base>, <minecraft:redstone>, <EnderIO:itemAlloy:1>);
