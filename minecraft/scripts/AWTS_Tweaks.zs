...
recipes.addShaped(<simplyjetpacks:components:24>, [[<ore:blockVibrantAlloy>, <EnderIO:itemBasicCapacitor:2>, <ore:blockVibrantAlloy>], [<ThermalDynamics:ThermalDynamics_0:4>, <EnderIO:itemBasicCapacitor:2>, <ThermalDynamics:ThermalDynamics_0:4>], [<ore:itemVibrantCrystal>, <ore:bucketRedstone>, <ore:itemVibrantCrystal>]]);
recipes.addShaped(<simplyjetpacks:components:23>, [[<ore:blockEnergeticAlloy>, <EnderIO:itemBasicCapacitor:1>, <ore:blockEnergeticAlloy>], [<ThermalDynamics:ThermalDynamics_0:2>, <EnderIO:itemBasicCapacitor:1>, <ThermalDynamics:ThermalDynamics_0:2>], [<ore:itemPulsatingCrystal>, <ore:blockRedstoneAlloy>, <ore:itemPulsatingCrystal>]]);
...
recipes.addShaped(<MineFactoryReloaded:machine.1:13>, [[<ore:itemPlastic>, <ore:gearEnderium>, <ore:itemPlastic>], [<EnderIO:item.darkSteel_sword>, <ThermalExpansion:Frame:3>, <ThermalFoundation:tool.swordPlatinum>], [<EnderIO:item.darkSteel_axe>, <EnderIO:itemBasicCapacitor:2>, <ThermalFoundation:tool.axePlatinum>]]);
...
recipes.addShaped(<TConstruct:diamondApple>, [[<minecraft:diamond_block>, <minecraft:diamond_block>, <minecraft:diamond_block>], [<minecraft:diamond_block>, <ore:cropApple>, <minecraft:diamond_block>], [<minecraft:diamond_block>, <minecraft:diamond_block>, <minecraft:diamond_block>]]);
...
recipes.addShaped(<ImmersiveEngineering:metalDecoration:5> * 2, [[<ore:ingotSteel>, <ImmersiveEngineering:material:12>, <ore:ingotSteel>], [<ImmersiveEngineering:metalDecoration:7>, <minecraft:piston>, <ImmersiveEngineering:metalDecoration:7>], [<ore:ingotSteel>, <ImmersiveEngineering:material:12>, <ore:ingotSteel>]]);
recipes.remove(<RedstoneArsenal:material:128>);
recipes.addShaped(<RedstoneArsenal:material:128>, [[<ore:ingotElectrumFlux>, <ore:gemCrystalFlux>, <ore:ingotElectrumFlux>], [<ore:gemCrystalFlux>, <ore:gemCrystalFlux>, <ore:gemCrystalFlux>], [<ore:ingotElectrumFlux>, <ore:gemCrystalFlux>, <ore:ingotElectrumFlux>]]);
recipes.remove(<RArm:ItemArmorPlating>);
recipes.addShaped(<RArm:ItemArmorPlating>, [[null, <RArm:ItemMaterials>, null], [<RArm:ItemMaterials>, <RedstoneArsenal:material:128>, <RArm:ItemMaterials>], [null, <RArm:ItemMaterials>, null]]);
